...
const categoryOptions = [
    ...
    // Trigger variable to isolate search submission from keystrokes
    const [searchTrigger, setSearchTrigger] = useState(0)

    // Fetch Logic wrapped in useCallback to keep hooks stable
    ...
    }, [activeOptionId, activeCategoryId, activeRatingId, searchTrigger])

    // Synchronize component mounting and parameter mutations
    useEffect(() => {
        getProducts()
    }, [getProducts])
